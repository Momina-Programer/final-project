...
import EmptyCart from '../assets/hero-img.jpg'
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row justify-between space-x-10 mt-8">
                    <div className="md:w-2/3">
                        <div className="flex justify-between border-b items-center md-4 text-xs font-bold">
                            <p> PRODUCTS </p>
                        ...
                        <div>
                            {cart.products.map((product) => (
                                ...
                                <div key={product.di} className="flex items-center justify-between p-3 border-b">
                        ...
                        <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md border">
                            ...
                            <div className="flex justify-between mb-5 border-bpb-1">
